 ...
 * <p>
 * Contains metrics including the number of input literals, the number of output clauses,
 * the total number of output literals, the length of the longest clause, and the average
