...
public class ICSETest extends BaseTest{
    ...
    Constraint nodeConstraint = new Constraint(List.of(new Literal(true, new NodeLabel(new Label("Stereotype", "internal"))),
            new Literal(false, new NodeLabel(new Label("Encryption", "Encrypted")))));
