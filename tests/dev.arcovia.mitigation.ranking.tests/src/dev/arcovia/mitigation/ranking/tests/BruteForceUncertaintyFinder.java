...
/*
 * Class finding a ordered list which will be used to determine the order of the brute force mitigation. The order gets
 * determined by the positions of the uncertainties in the TFGs.
 */
public class BruteForceUncertaintyFinder {
    ...
    public static List<String> getBruteForceUncertaintyEntityNames(UncertaintyAwareConfidentialityAnalysis analysis) {
        ...
        for (var tfg : allTFGs) {
            var newEntityNames = tfg.getRelevantUncertaintySources()
                    .stream()
