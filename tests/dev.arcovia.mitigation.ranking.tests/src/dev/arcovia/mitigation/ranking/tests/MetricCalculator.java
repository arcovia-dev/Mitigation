...
public class MetricCalculator {
    ...
    public static float calculatePAtK(int k, List<String> correctRanking, List<String> evaluatingRanking) {
        ;
        var correctElementsCount = evaluatingRanking.stream()
                .limit(k)
    ...
    public static float calculateMAPAtK(int k, List<String> correctRanking, List<String> evaluatingRanking) {
    ...
    public static int determineR(List<String> correctRanking, List<String> evaluatingRanking) {
        var lastIndex = 0;
