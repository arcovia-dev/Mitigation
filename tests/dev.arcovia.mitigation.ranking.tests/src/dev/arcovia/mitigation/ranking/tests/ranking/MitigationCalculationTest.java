...
public class MitigationCalculationTest extends MitigationTestBase {
    ...
    public void testMitigationModel() {
        ...
        var allEntityNames = analysis.getUncertaintySources()
                .stream()
        ...
        var bcFlow = mitigationModels.get(0)
                .model()
                .dataFlowDiagram()
                .getFlows()
                .stream()
                .filter(f -> f.getSourceNode()
                        .getEntityName()
                        .equals("b")
                        && f.getDestinationNode()
                                .getEntityName()
                                .equals("c"))
                .findAny();
        var ceFlow = mitigationModels.get(0)
                .model()
                .dataFlowDiagram()
                .getFlows()
                .stream()
                .filter(f -> f.getSourceNode()
                        ...
                        && f.getDestinationNode()
                                ...
                                .equals("e"))
                .findAny();
        var iNode = mitigationModels.get(0)
                .model()
                .dataFlowDiagram()
                .getNodes()
                .stream()
                .filter(n -> n.getEntityName()
                        .equals("i"))
                .findAny();
        var kProp = mitigationModels.get(0)
                .model()
                .dataFlowDiagram()
                .getNodes()
                .stream()
        ...
        assertTrue(kProp.getEntityName()
                .equals("EU"));
    }
