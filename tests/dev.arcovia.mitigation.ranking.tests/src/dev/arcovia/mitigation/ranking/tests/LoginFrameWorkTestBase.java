...
/*
 * Class for the evaluation of the scaleability of the mitigation approach Was not used in thesis because the model was
 * too small.
 */
public abstract class LoginFrameWorkTestBase extends MitigationTestBase {
    ...
    private void executeMitigationRuns(MitigationStrategy strategy, String id) {
        ...
        storeMeassurementResult(training_durations.stream()
                .sorted(Comparator.reverseOrder())
                .limit(avg_amount)
                .reduce(0L, Long::sum) / avg_amount, "T" + id);
    }
}