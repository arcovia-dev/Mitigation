...
/**
 * Wraps a {@link DataCharacteristicsSelector} to add a literal representing a constant data characteristic to a
...
public class ConstantDataCharacteristicSelector implements ConstantDataSelector {
    ...
    /**
     * Adds a literal to the root node representing this constant data characteristic. Ensures that both the characteristic
     * type and value are constant; throws an exception otherwise.
