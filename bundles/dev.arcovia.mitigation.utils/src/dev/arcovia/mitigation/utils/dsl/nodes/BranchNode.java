 ...
 * <p>
 * A {@link BranchNode} contains one or more {@link LogicNode} predicates that define the structure of the logical
 * expression. Implementations must define how predicates are added and how CNF clauses are collected.
 */
