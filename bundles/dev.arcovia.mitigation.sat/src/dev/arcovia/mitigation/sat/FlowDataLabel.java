...
/**
 * The FlowDataLabel record encapsulates a Flow and its associated IncomingDataLabel. It is used to represent the
 * pairing of a unidirectional data Flow with a specific label that provides additional context or metadata for the
 * incoming data in the flow.
