...
public class ConjunctionNode {
	protected final List<ConjunctionNode> predicates;
	protected final LogicNodeDescriptor descriptor;
	protected final Literal literal;
	
	public ConjunctionNode(LogicNodeDescriptor descriptor) {
		this.predicates = new ArrayList<ConjunctionNode>();
		this.descriptor = descriptor;
		this.literal = null;
	}
	
	public ConjunctionNode(Literal literal) {
		this.predicates = null;
		this.descriptor = LogicNodeDescriptor.LITERAL;
		this.literal = literal;
	}
	
	public void addPredicate(ConjunctionNode predicate) {
