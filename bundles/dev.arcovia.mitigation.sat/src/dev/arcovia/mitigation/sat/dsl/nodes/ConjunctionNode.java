 ...
 * add predicates, collect CNF clauses from its children, and generate a string
...
public class ConjunctionNode implements BranchNode {
    ...
    /**
     * Adds a predicate to the list if it is not already present.
     * This method is used only for constructing a formula tree from the CNF, not for the DSL.
     *
    ...
    /**
     * Returns a string representation of this node by concatenating all predicate strings with "AND".
