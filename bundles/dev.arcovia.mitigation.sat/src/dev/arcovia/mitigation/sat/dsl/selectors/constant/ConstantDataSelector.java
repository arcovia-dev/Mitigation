 ...
 * <p>
 * Implementations of this interface operate on fixed (constant) data characteristics and
 * directly insert the corresponding literals into the given {@link BranchNode}.
 * This is typically used for constructing CNF formulas from static data constraints.
 *
 * @see BranchNode
 */
