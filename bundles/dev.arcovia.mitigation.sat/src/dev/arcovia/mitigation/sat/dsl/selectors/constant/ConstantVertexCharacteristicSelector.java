...
/**
 * Wraps a {@link VertexCharacteristicsSelector} to add a literal representing a constant
 * vertex characteristic to a {@link BranchNode}. Validates that both the characteristic type
