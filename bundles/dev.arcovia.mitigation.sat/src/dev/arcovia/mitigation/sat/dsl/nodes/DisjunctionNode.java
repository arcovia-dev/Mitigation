 ...
 * <p>
 * Contains a list of predicate {@link LogicNode} elements and provides methods to
 * add predicates, collect CNF clauses with branching for each predicate, and generate
 * a string representation of the disjunction.
 * <p>
...
public class DisjunctionNode implements BranchNode {
    ...
    /**
     * Adds the specified predicate to the list if it is not already contained.
     * Intended only for constructing a formula tree from the CNF, not for the DSL.
     *
    ...
    /**
     * Collects CNF clauses from each predicate, creating separate branches of active constraints
     * for all but the first predicate. Each branch is processed recursively, and resulting
     * constraints are accumulated in the provided result list.
     *
    ...
    /**
     * Returns a string representation of this node by concatenating all predicate strings with "OR".
     * Empty predicates are skipped, and multiple predicates are enclosed in parentheses.
     *
