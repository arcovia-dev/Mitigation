...
while printedCount < RELEVANT_UNCERTAINTIES_LENGTH and bool(final_ranking):
    ...
    # DO not take uncertainties into account if the irrelevant attribute ('I') led to the high score
    if uncertainty_name not in relevant_uncertainties and column != 'I':
